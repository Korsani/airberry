...
festivaltest=$(checkNeededFiles -q may festival && echo yes )
#
#To skip package check simply change below to aircracktest="yes"
aircracktest=$(checkNeededFiles -q must aircrack-ng && echo yes )
#
...
if [ x"$1" = x"help" -o x"$1" = x"--help" -o x"$1" = x"-help" ];then
	...
	echo "clean		#Removed everything from the current DIR except "
